...
<form action="store_event_details.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="chk2[ ]" value="Weekday">Weekdays<br />  
                <input type="checkbox" name="chk2[ ]" value="Weekend">Weekends<br />  
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="chk3[ ]" value="Toybank Ambassador">Play sessions with Children<br />  
